...
public class OverrideObjectMethod_04 {
    public static void main(String[] args) {
        User_04 u1=new User_04("Tom", 25);
        User_04 u2=new User_04("Tom", 25);
        ...
        User_04 u3=new User_04("Jerry", 22);
        System.out.println(u3);  //User_04{name='Jerry', age=22}
        System.out.println(u3.toString());  //User_04{name='Jerry', age=22}
